...
def get_endpoints():
    endpoints = {
      "/api/villains/": "GET - Retrieve all villains from database",
      "/api/villains/delete": "POST - delete a villain if you exist in the database",
      "/api/vilains/add": "POST - add a villain from database"
    }
